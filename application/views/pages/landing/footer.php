        ...
        <div class="col-lg-8 col-md-12">
            <div class="row">
                <div class="col-md-4 mb-5">
                    ...
                    <p><i class="fa fa-map-marker-alt mr-2"></i>#21 Unit i J. Elizalde St., Phase 1 BF Homes, Parañaque, Philippines</p>
                    <p><i class="fa fa-phone-alt mr-2"></i>+639065841986</p>
                    <p><i class="fa fa-envelope mr-2"></i>kruhay.animalclinic@gmail.com</p>
                    <div class="d-flex justify-content-start mt-4">
                        <a class="btn btn-outline-light rounded-circle text-center mr-2 px-0" style="width: 36px; height: 36px;" href="https://www.facebook.com/kruhay.animalclinic" target="_blank"><i class="fab fa-facebook-f"></i></a>
                    </div>
                </div>
            </div>
        </div>
