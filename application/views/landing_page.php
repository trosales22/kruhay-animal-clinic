    ...
    <div class="container-fluid bg-light">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 py-5 px-4 px-sm-5">
                    <div class="bg-primary py-5 px-4 px-sm-5">
                        <form class="py-2">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control border-0 p-4" placeholder="Address (for Home Service)" />
                            </div>
                            <div class="form-group">
                            ...
                            ?>
                            <div>
                                <button type="submit" class="btn btn-success btn-block border-0 py-3" type="submit">Book Now</button>
                            </div>
                            <?php }else{?>
